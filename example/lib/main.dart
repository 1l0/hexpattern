...
class NosutaTheme {
  static ThemeData get dark => ThemeData.from(
        colorScheme: const ColorScheme.dark(
          ...
          onSurface: Color.fromARGB(255, 213, 213, 213),
          onSurfaceVariant: Color.fromARGB(255, 255, 255, 255),
          tertiary: Color.fromARGB(255, 122, 122, 122),
          outline: Color.fromARGB(255, 80, 80, 80),
        ),
      );
  ...
  static ThemeData get light => ThemeData.from(
        colorScheme: const ColorScheme.light(
          ...
          secondary: Color.fromARGB(110, 173, 173, 173),
